...
*use_device and the other fleet tools, mounted only when `TINY_MCP=1` — with the self-refusal guard* — `tools/tiny_mcp.py`, 1 tool.
...
<small>source: <a href="https://github.com/cagataycali/scout-the-rover/blob/main/tools/tiny_mcp.py#L339">tools/tiny_mcp.py:339</a></small>
